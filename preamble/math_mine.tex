...
\NewDocumentCommand{\gleadsto}{O{γ}}{⇝_{#1}}
...
\NewDocumentCommand{\ileadsto}{O{i}}{⇝_{#1}}%Or \dashrightarrow?
\NewDocumentCommand{\nileadsto}{O{i}}{\not⇝_{#1}}
\NewDocumentCommand{\ileadstoe}{O{i}}{⇝_{#1}^\exists}
\NewDocumentCommand{\nileadstoe}{O{i}}{\not⇝_{#1}^\exists}
\NewDocumentCommand{\ileadstost}{}{\hookrightarrow^i}
\NewDocumentCommand{\nileadstost}{}{\not\hookrightarrow^i}
\NewDocumentCommand{\di}{}{d^\phi_i}
\NewDocumentCommand{\dip}{}{d^{\phi +}_i}
\NewDocumentCommand{\ibeats}{}{⊳^\text{\sout{\ensuremath\phi}}_i}
\NewDocumentCommand{\nibeats}{}{⋫^\text{\sout{\ensuremath\phi}}_i}
