...
\NewDocumentCommand{\commentClaude}{O{}m}{\ifx&#1&\else\hl{#1} \fi\textcolor{teal}{{\small$\big[$Claude: #2$\big]$}}}
\NewDocumentCommand{\TODO}{m}{\textcolor{blue}{\small$\big[$TODO: #1$\big]$}}
...
\newunicodechar{υ}{\upsilon}
%03C6 Greek Small Letter Phi (“the ordinary Greek letter, showing considerable glyph variation; in mathematical contexts, the loopy glyph is preferred, to contrast with 03D5 φ” – The Unicode Standard 13.0, U+0370–U+03FF, https://www.unicode.org/charts/PDF/U0370.pdf)
\newunicodechar{φ}{\phi}
...
\newunicodechar{ω}{\omega}
%03D5 Greek Phi Symbol (“used as a technical symbol, with a stroked glyph” – The Unicode Standard 13.0)
...
%→ is defined by default as \textrightarrow, which is invalid in math mode. Same thing for other commands. 
%→ Rightwards Arrow
\DeclareUnicodeCharacter{2192}{\ifmmode\rightarrow\else\textrightarrow\fi}
%→ Rightwards Double Arrow
\DeclareUnicodeCharacter{21D2}{\Rightarrow}
%↑ Upwards Arrow
\DeclareUnicodeCharacter{2191}{\ifmmode\mathop{\uparrow}\else\textuparrow\fi}
