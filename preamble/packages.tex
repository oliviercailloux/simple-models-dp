...
%Permits to customize enumeration display and references
	...
	%}{
	%}
%Provides \Centering, \RaggedLeft, and \RaggedRight and environ­ments Center, FlushLeft, and FlushRight, which allow hyphenation. With tikzposter, seems to cause 1=1 to be printed in the middle of the poster.
	%\usepackage{ragged2e}
