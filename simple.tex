...
\begin{definition}[Truthfulness]
	\label{def:truth}
	An argumentative theory $(\pga, \arga, \dg)$ for the exposure protocol $(I, \allargs, {\leadsto})$ is \emph{truthful} iff $\forall i \in I, \hist \in \allhist, \ar \in \histend, \ar_1 \in \histend: [\hist \nileadsto \pga] ⇒ [\dg(\ar_1, \hist) ≠ \emptyset \land (\hist, \dg(\ar_1, \hist)) \ileadsto \pga]$.
\end{definition}
