...
\begin{axiom}[Self-sufficiency of positive arguments, version for $\ar$]
	...
	\begin{equation}
		...
		⇒ (\hist, \ar_1, \ar_2, \ar) \nileadsto \pga,
	\end{equation}
	and, $\forall \ar_1, \ar_2 \in \gargsi, \hist \in \allhist$:
	\begin{equation}
		\left.\begin{aligned}
			&(\hist, \ar_1) \nileadsto \pga \\
			&(\hist, \ar_2) \nileadsto \pga
...
\begin{proof}
	...
	By TF, $(a_4, \arga, \ar_2, a, \ar_3, ?) \ileadsto \pga$ (where $?$ stands for any argument or nothing).
	By Reinst, $(a_4, \arga, \ar_3, ?) \ileadsto \pga$.
	By Self-s, $(a_4, \ar_3, ?) \ileadsto \pga$.
	
	Now consider $(\ar_5, \ar_2) \ileadsto \pga$. (Or any such path not ending with $\ar_3$.)
	By Answ, $\exists a \suchthat (\ar_5, \ar_2, a) \nileadsto \pga$.
	We obtain $(\ar_5, \ar_3) \ileadsto \pga$.
\end{proof}
