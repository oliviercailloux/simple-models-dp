...
\begin{proof}
	...
	To prove the lemma, let us pick any $\phi \in {\gleadsto}(\allargs)$ and $\ar[k] \in \gargs[\phi]$ such that $\ar[k] \nileadstost \phi$. We know that $\exists \ar_1 \in \allargs \suchthat \ar_1 \ibeatse[!\phi] \ar[k]$. Therefore, by Answerability, $\exists \ar_1' \in \allargs \suchthat \ar_1' \gbeatsstar \ar[k]$, and, by Operational validity, $\exists \ar_2 \in \gargs[\phi] \suchthat \ar_2 \gbeats \ar'_1$. 
