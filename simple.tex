...
Given a decision situation, we define the relations $\wibeatse[\phi], \nwibeatse[¬\phi] \subseteq \mbeats$ in order to obtain the following result.
...
{Check: Given $\ar_4 \mbeats \ar_3, \ar_3 \notin \mleadstoinv(\alltopic)$, with $\ar_2 \in \mbeats(\ar_3)$ ⇒ ($\ar_2$ and $\ar_4 + \ar_2$ $\mbeats$-attack only root nodes and do not support any proposition): $\ar_4 \wibeatse[\phi] \ar_3$ iff
\begin{itemize}
	\item $\exists \ar_2 \in \mbeats(\ar_3) \suchthat [(\ar_3 \wibeatse[\phi] \ar_2) ∧ (\ar_3 \nwibeatse[\phi] \ar_4 + \ar_2)]$ iff 
	\item $\exists \ar_2 \in \mbeats(\ar_3) \suchthat [(\exists \ar_1 \in \mbeats(\ar_2) \suchthat \ar_2 \wibeatse[\phi] \ar_1 ∧ \ar_2 \nwibeatse[\phi] \ar_3 + \ar_1) ∧ (\exists \ar_1 \in \mbeats(\ar_4 + \ar_2) \suchthat \ar_4 + \ar_2 \wibeatse[\phi] \ar_1 ∧ \ar_4 + \ar_2 \wibeatse[\phi] \ar_3 + \ar_1)]$ iff 
	\item $\exists \ar_2 \in \mbeats(\ar_3) \suchthat [(\exists \ar_1 \in \mbeats(\ar_2) \suchthat \ar_1 \ileadsto t ∧ (\ar_2, \ar_1) \ileadstose ¬\phi ∧ \ar_3 + \ar_1 \ileadsto \phi ∧ (\ar_3 + \ar_1, \ar_2) \ileadstope \phi ∧ (\exists \ar_1 \in \mbeats(\ar_4 + \ar_2) \suchthat \ar_1 \mleadsto \phi ∧ (\ar_4 + \ar_2, \ar_1) \ileadstose ¬\phi ∧ \ar_3 + \ar_1 \ileadsto \phi ∧ (\ar_4 + \ar_2, \ar_3 + \ar_1) \ileadstose ¬\phi)]$.
\end{itemize}
}
...
\begin{definition}[Covering]
	$\forall \phi, \ar \in \gdargs^\phi, \ar' \in \allargs: \ar' \ibeatse[\phi] \ar ⇒ \ar' \mbeats \ar$. 
\end{definition}
