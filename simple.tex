...
Given $i \in I, \phi \in \Phi, \ar_1, \ar_0 \in \allargs$, define $\ar_1 \ibeats \ar_0$ iff $\exists \hist \in \allhist \suchthat \ar_1 \in (\gbeatsinv(\ar_0) \cap \hist) \land \ar_0 \in \histend \land \hist \nileadsto \phi \land (\gbeatsinv(\ar_0) \cap \hist) \setminus \set{\ar_1} \sinef \ar_0$.
...
\begin{proof}
	...
	By definition, this means that $\ar_1 \ibeats \ar_0$ and, as $\ar_1 \in \args^{\histp} = \gbeatsinv(\ar_0) \cap \histp$, $\ar_1 \gbeats \ar_0$. 
...
\RenewDocumentCommand{\ileadstost}{O{}}{⇝^{#1}_\forall}
