...
\begin{theorem}
	...
	\begin{equation}
		\left\{\begin{aligned}
			&(…, \ar_k, ?, \nileadstog \phi, …, \ar_l, ?) \ileadstog \phi;\\
			&\forall \histk \in (…, \ar_k, ?) \suchthat \histk \nileadstog \phi: (\histk, …, \ar_l, ?) \ileadstog \phi;\\
			&(…, \ar_l, ?, \nileadstog \phi, …, \ar_k, ?) \ileadstog \phi.
		\end{aligned}\right.
	\end{equation}
	...
	\begin{equation}
		\left\{\begin{aligned}
			&\exists \histk \in (…, \ar_k, ?) \suchthat \histk \nileadsto \phi \land (\histk, …, \ar_l, ?) \ileadsto \phi;\\
			&\exists \histl \in (…, \ar_l, ?) \suchthat \histl \nileadsto \phi \land (\histl, …, \ar_k, ?) \ileadsto \phi.
		\end{aligned}\right.
	\end{equation}
\end{theorem}
\begin{proof}
