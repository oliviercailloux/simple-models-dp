...
Finally, the current proposal links \ac{DJ} and deliberated preferences. \commentYM{indispensable de dire explicitement quelle est la différence entre les deux dès maintenant}
...
It may be argued that because this proposition needs a normative axiom, which cannot be validated empirically, it does not fare better than the alternative propositions examined in the previous sections. \ac{SEU}, for example, also claim to obtain reflective preferences on the basis of normative axioms.
...
However, it is good to lighten as much as possible the content of normative axioms, and defer as much content as possible to descriptive claims. The descriptive parts of theories can be confronted to observations, a natural way to lift disagreements that has often proved useful in the history of science (again, accepting this claim does not require to ignore that observations themselves rest upon theories). Arguably, the normative axiom proposed here is much weaker than those of a theory such as \ac{SEU}, in the sense of having less substance or of being compatible with more preference relations. (This claim can only be valid at an intuitive level: because \ac{SEU} does not use arguments, its axioms cannot be compared formally to mine.) This does not prevent theories of \ac{DJ} to propose substantive, non-trivial claims about reflective preferences. It simply moves the debate from the world of discussions between experts about the validity of the axioms to the world of observations of acceptability of arguments by the persons to which these theories claim to be applicable.
It is also worth noting that this axiom has a specific form that may permit decision makers to reconstruct the reasoning proposed by the theory so as to be able to check that they apply to their situation. Detailed exploration of this aspect is deferred to future work.
...
\commentOCf{Je pense changer d’approche : enlever cette section et intégrer les explications informelles directement dans la présentation formelle. À faire…}
