...
Given ${\ileadstog}$, $p \in P$ and $S \subseteq \allargs$, let $S \ileadstog p$ stand for $\forall s \in S: s \ileadstog p$ and $s \in S \ileadstog p$ stand for $s \in \set{s \in S \suchthat s \ileadstog p}$.
...
\begin{theorem}
	...
	\begin{equation}
		...
		\forall \hist \in (…, \ar_1, ?) \nileadstog p: (\hist, …, \ar_2, ?) \ileadstog p.
	\end{equation}
	...
	\begin{equation}
		...
		\exists \hist \in (…, \ar_1, ?) \nileadsto p \suchthat (\hist, …, \ar_2, ?) \ileadsto p.
	\end{equation}
\end{theorem}
\begin{proof}
...
\begin{theorem}[Formal]
	Pick any $\ar_k ≠ \ar_l$ and $p \in P$ and assume that $\allleadsto$ fails the above consequence, that is, satisfies:
	\begin{equation}
		\label{eq:answerable}
		\forall i \in I, \exists \set{\ar_1, \ar_2} \suchthat \set{\ar_1, \ar_2} = \set{\ar_k, \ar_l} \land
		\forall \hist \in (…, \ar_1, ?) \nileadsto p: (\hist, …, \ar_2, ?) \nileadsto p.
	\end{equation}
	Assume further that $\allleadsto$ satisfies \eqref{eq:cl}, thus:
	$\forall i \in I, \forall \set{\ar_1, \ar_2} \suchthat \set{\ar_1, \ar_2} = \set{\ar_k, \ar_l},
\forall \hist \in (…, \ar_1, ?) \nileadsto p: (\hist, …, \ar_2, ?) \ileadsto p$.
...
%	Then, intuitively, $\ar_k$ decisive is in $S_O \cap C$.
	...
	We have ${\allleadstog'} \in S_O \cap C$, which concludes [NB need to do it for each $i$, instead].
