...
Define $\hist \ileadsto \phi_{B, a}$ iff $a \in B_{\hist, i}$.
Define $\hist \ileadsto \phi_{B, ¬a}$ iff $a \notin B_{\hist, i}$.

Given $a, b \in \allalts$, define $a \pst b$ iff $\forall \set{a, b} \subseteq B: \phi_{B, ¬b} \in \gPhi$.
Define $a \ind b$ iff $ \forall c \in \allalts: [a \pst c ⇔ b \pst c] \land \forall \set{a, b} \subseteq B: [\phi_{B, a} \in \gPhi ⇔ \phi_{B, b} \in \gPhi]$.
Define ${\peq} = {\pst} \cup {\ind}$.

The $\peq$ relation is reflexive because $a = b ⇒ a \ind b$.
\begin{proposition}[Transitivity]
	The $\peq$ relation is transitive.
\end{proposition}
\begin{proof}
	Well, this is false.
\end{proof}
