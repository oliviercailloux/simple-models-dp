...
(TODO Alt: very strong, $\forall \allleadsto \in C, i, j \in I: \ileadsto = \jleadsto$; misses for example $\card{\set{i \suchthat \hist \ileadsto \phi}} = \frac{I}{2}$; strong: $\set{\ileadsto \suchthat \allleadsto \in C} = \set{\jleadsto \suchthat \allleadsto \in C}$; misses perhaps “if $i$ says… then $j$ says…”.)
\begin{example}
