...
Define $f_\prop$ from any unordered pair of arguments $(\ar, \ar')$ into $\powerset{\prop\text{-sure}, ¬\prop\text{-sure}, b)}$ (where $b$ means both possible). We The set designates all cumulated answers over time, thus allowing $i$ to be unstable (because she has learnt new things in between two questioning, or just because of time passing, or for any known or unknown reason). We assume $b$ is observable as well.
