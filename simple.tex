...
Given $\hist \in \allhist$ and $\ar_k, \ar_l \in \allargs$, let $(\hist, \ar_k, ?, ✗, …, \ar_l, ?)$ denote the set 
...
Given $\ar_k, \ar_l \in \allargs$, let $(…, \ar_k, ?, ✗, …, \ar_l, ?)$ denote the set 
$\cup_{\hist \in \allhist} (\hist, \ar_k, ?, ✗, …, \ar_l, ?) = 
...
\begin{theorem}
	Given any $\phi \in P, \ar_k, \ar_l \in \allargs$, consider the following claim $C$: $\forall i \in I$,
	\begin{equation}
		\left\{\begin{aligned}
			&\forall \histk \in \allhist \suchthat \ar_k \in \histkend \land \histk \nileadstog \phi: \set{\histl \suchthat \histk \subseteq \histl \land \ar_l \in \histlend} \ileadstog \phi;\\
			&\forall \hist \in \allhist \suchthat \ar_l \in \histend \land \hist \nileadstog \phi: \set{\histp \suchthat \hist \subseteq \histp \land \ar_k \in \histpend} \ileadstog \phi.
		\end{aligned}\right.
	\end{equation}
	In short,
