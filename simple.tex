...
\begin{definition}[Truthfulness]
	\label{def:truth}
	An argumentative theory $(\pga, \arga, \dg)$ for the exposure protocol $(I, \allargs, {\leadsto})$ is \emph{truthful} iff $\forall i \in I, \ar_2 \in \dgi(\arga), \ar_3 \in \dgi(\ar_2), …, \forall \hist \in \allhist \suchthat \hist = (\arga, …, \ar_2, …, \ar_3, …) \land \ar_3 \in \histend: [\hist \nileadsto \pga ⇒ d(\ar_3, \hist) ≠ \emptyset]$.
\end{definition}
