...
\Cref{prop:cohb} can’t be proven, but the following weaker versions can: $\forall \phi \in \Phi: \phi \in \mPhi ⇒ ¬\phi \in \iPhirej$ and $\forall \phi \in \Phi: \propsure \in \mPhi ⇒ ¬\propsure \in \iPhirej$.
...
\begin{axiom}[Coherent negation]
	$\forall \phi \in \Phi: \phi \in \iPhi ⇔ ¬\phi \in \iPhirej$.
\end{axiom}
