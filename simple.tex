...
\begin{theorem}
  ...
  An attitude $f$ is observably included in a set of attitudes $S$ iff $\forall \hist \in \allhists: \cap_{\histp \wsub \hist} l^S_f(\histp) \neq \emptyset$.
\end{theorem}
\begin{proof}
