...
\label{sec:dynamic}
An argumentative theory of \ac{DC} is defined as a tuple $(p, \gleadsto, \dg)$, where $p \in P$ is the proposition supported by the theory, ${\gleadsto} \subseteq \allargs × \allprops$ is an initial argumentation relation and $\dg$ is a defense relation; satisfying bounded depth.
