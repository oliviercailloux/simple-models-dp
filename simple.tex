...
\end{proof}
Note that the reverse implication of $\cref{th:holdsiff} does not hold: a claim may hold and be not a posteriori falsifiable but be not a priori falsifiable.
