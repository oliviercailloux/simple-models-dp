...
A descriptive theory for a normative theory of \ac{DJ} is defined as a tuple $(\gC, \gPhi)$, where $\gC \subseteq \powerset{I × \allhist × \Phi}$ is a falsifiable claim and $\gPhi \subseteq \Phi$ are the proposition that the theory claims are in the \acp{DJ} of the individuals.
...
A claim $\gC \subseteq \powerset{I × \allhist × \Phi}$ represents the theory’s claim about the relation $\leadsto$: the theory claims that $\leadsto \in \gC$. 
A claim $\gC \subseteq \powerset{I × \allhist × \Phi}$ is falsifiable iff 
