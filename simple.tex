...
Given a pair $(I, \allargs)$, a general observation $θ$ is a right unique finite subset of $(I × \allhist) × P$ such that $\forall i \in I, (i, \hist, p), (i, \histp, q) \in θ: \card{\hist} ≤ \card{\hist'} \implies \hist \subseteq \hist'$.
...
\begin{theorem}
  ...
  $\forall {\allleadstog} \in \Cbar, \exists O \subseteq {\allleadstog} \suchthat S_O \subseteq \Cbar$, or equivalently:
  $\forall {\allleadstog} \in \Cbar, \exists O \subseteq {\allleadstog} \suchthat S_O \subseteq \Cbar$.
\end{theorem}
