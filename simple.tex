...
\begin{theorem}
  Assume that $I$ is finite and $P_{i_1} = \phi$ and $\forall i \in I \setminus \set{i_1}: P_i = ¬\phi$.
...
\begin{proof}
  ...
  Define $a_1$ as an argument decisive in favor of $\phi$ for $i_1$ and $a_i$ as arguments decisive in favor of $¬\phi$ for $i \in I \setminus \set{i_1}$.
  
  Assume (wlog) that $I = \set{i_1, …, i_{\card{I}}}$.
  Define $\hist_1 = \emptyset$ and for $i \in \intvl{2, \card{I}}$, $\hist_i = (\hist_{i - 1}, a_1, a_i)$.
  We know that, $\forall i \in \intvl{2, \card{I}}$: $\hist_i \ileadsto[i_1] \phi$ and $\hist_i \ileadsto[i] ¬\phi$.
  Define $\theta = \set{(\hist_i, i_1, \phi) \suchthat i \in \intvl{2, \card{I}}}$.
  
  Finally, the attitudes in $C$ compatible with $\theta$ are only $\set{{\allleadstog} \suchthat \theta \wsub {\allleadstog}} \cap C = \set{{\allleadstog} \suchthat {\ileadstog[i_1]} = {\ileadsto[i_1]}}$, and $\pi(\set{{\allleadstog} \suchthat {\ileadstog[i_1]} = {\ileadsto[i_1]}})(i_1) = \phi$.
\end{proof} 
...
\begin{proof}
  ...
  Finally, the attitudes in $C$ compatible with $\theta$ are only $\set{{\allleadstog} \suchthat \theta \wsub {\allleadstog}} \cap C \wsub \set{{\allleadstog} \suchthat {\ileadstog[i_1]} \in \set{{\ileadsto[j]} \suchthat j \in I_1}}$, and $\pi(\set{{\allleadstog} \suchthat {\ileadstog[i_1]} \in \set{{\ileadsto[j]} \suchthat j \in I_1}})(i_1) = \phi$.
\end{proof}
