...
\begin{theorem}
	Given any $p \in P, \ar_k, \ar_l \in \allargs$, consider the following claim $C$: $\forall i \in I$,
	\begin{equation}
		\left\{\begin{aligned}
			&\forall \histk \in (…, \ar_k, ?) \nileadstog p: (\histk, …, \ar_l, ?) \ileadstog p;\\
			&\forall \histl \in (…, \ar_l, ?) \nileadstog p: (\histl, …, \ar_k, ?) \ileadstog p.
		\end{aligned}\right.
	\end{equation}
	...
	\begin{equation}
		\left\{\begin{aligned}
			&\exists \histk \in (…, \ar_k, ?) \nileadsto p \suchthat (\histk, …, \ar_l, ?) \ileadsto p;\\
			&\exists \histl \in (…, \ar_l, ?) \nileadsto p \suchthat (\histl, …, \ar_k, ?) \ileadsto p.
		\end{aligned}\right.
	\end{equation}
\end{theorem}
\begin{proof}
	$\ar_k \nileadstost p$ iff $\exists \histk \suchthat \ar_k \in \histkend \land \histk \nileadsto p$.
\end{proof}
\begin{remark}
	Idea.
