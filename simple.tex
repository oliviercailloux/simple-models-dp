...
The observation protocol goes as follows. Given $i$ and $\emptyset ≠ B \subseteq \allalts$ and $\hist$, $i$, after having been presented $\hist$, is asked to choose among a subset of elements from $B$ among which she is indifferent. Define $\emptyset ≠ c^\hist_i(B) \subseteq B$ as the subset that $i$ chooses as her indifference choice after exposure to $\hist$.
