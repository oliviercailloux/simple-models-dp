...
Say that $\gamma$ has depth at least $k \in \N^*$ iff $\exists (\alpha_i, 1 ≤ i ≤ k) \suchthat \forall 1 ≤ i ≤ k, \dg(\set{\alpha_j \suchthat 1 ≤ j ≤ i - 1}) \subsetneq \dg(\set{\alpha_j \suchthat 1 ≤ j ≤ i}) \land \forall 1 ≤ i ≤ k - 1, \alpha_i \cup \set{\dg(\alpha_i)} \subseteq \alpha_{i + 1}$.
...
For example, $\gamma$ has depth $0$ iff $\dg = \emptyset$; and $\gamma$ has depth $1$ iff $[\exists \alpha_1 \suchthat \dg(\alpha_1) ≠ \emptyset] \land [\forall \alpha_1, \alpha_2 \suchthat \dg(\alpha_1) ≠ \emptyset \land \alpha_1 \cup \set{\dg(\alpha_1)} \subseteq \alpha_2: \dg(\alpha_2) \subseteq \dg(\alpha_1)]$.
