...
\begin{proof}
  ...
  Thus, $g \in R(S)$.
\end{proof}
Define the closure under observable inclusion of a claim about types $S$ as $R^\infty(S)$, equivalently, as the smallest set $S'$ such that $S \wsub S'$ and $R(S') \wsub S'$, equivalently, as indicated by \cref{th:RR}, as $R(S)$.
\begin{remark}
...
\end{theorem}
\begin{theorem}
  Given any situation, if the claim associated to the set of attitudes $R^\infty({\allleadsto}(I))$ is trivial, then there exists no claim associated to a set of attitudes that holds and is falsifiable.
\end{theorem}
\begin{proof}
...
\end{proof}
\begin{theorem}
  Given any situation, the claim associated to the set of attitudes $R^\infty({\allleadsto}(I))$ holds, is anonymous, and is falsifiable or trivial.
\end{theorem}
