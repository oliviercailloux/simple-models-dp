...
\section{Motivation} 
\commentYM{dans la mesure où tu dis concevoir ou avoir conçu ce draft comme étant presque soumettable, pourquoi as-tu cette section "motivation" plutôt qu'une classique introduction ?}}
It has escaped nobody’s attention that 
studying reflective preferences, in supplement to shallow preferences, is an important endeavor for economics: we want to recommend to individual decision makers; we want to adopt optimization criteria for society, and this ought not to merely faithfully reproduce unreflectful behavior.\commentYM{je trouve cette entame provocatrice assez maladroite, car elle s'appuie sur l'opposition reflective vs. shallow preference, qui ne parle (je pense) pas immédiatement au lecteur. Je pense indispensable de définir cette dichotomie avant d'en parler. Par ailleurs que veut dire "is an important endeavor for economics" ? Il me semble au contraire que c'est une tâche qui devrait tenir à coeur aux économistes, mais qui pourtant n'est pas pour eux une tâche à laquelle ils s'attèlent vigoureusements. Enfin, l'anglais de cette phrase me semble un peu maladroit} This is one important difference between the normative and the (inappropriately called, as will be seen) “descriptive” approach in economics\commentYM{où discutes-tu cette distinction, dans son application à l'économie en particulier ?}. As \citet{hausman_preference_1994} illustrate with an example of a person drinking a fatal poison while erroneously thinking that it is water, shallow preferences are not sufficient to inform normative economics.
...
This article is interested in defining theories of decision making based on another kind of observable data\commentYM{other than what? Juste avant tu dis que les autres s'appuient sur des données qui ne reflètent pas les préférences qui t'intéressent, et maintenant tu dis que tu vas regarder autre chose qu'eux. Cela donne l'impression que tu tournes autour du pot, car tu ne dis pas ce que les autres regardes et pourquoi ça ne t'intéresse pas}, namely, the reactions of decision makers to arguments. This permits to overcome a current important limitation of normative approaches, that of being not empirical (in a sense that will be developed below).\commentYM{phrase incompréhensible pour le lecteur, puisque tu dis toi même que tu en expliqueras les termes plus tard. C'est une rhétorique difficile à tenir dans une introduction}
