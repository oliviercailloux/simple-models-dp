...
\begin{example}
  ...
  Observe that $C^\subseteq = \set{R \in I × \allhists × P \suchthat [(j, \hist) \in R^{-1}(P) \implies (j, \hist, \phi) \in R] \land \forall i: [(i, (\ar)) \in R^{-1}(P) \land (i, (\ar')) \in R^{-1}(P)] \implies [(i, (\ar), \phi) \in R \land (i, (\ar'), \phi) \in R]}$.
  ...
  Given any $O$, define $f(O) = \restr{\allleadstog}{O}$ and observe that $f(O) \in C^\subseteq$ although $\cup_{O \in \allpriobss} f(O) \notin C$.
\end{example}

TODO continue here (finish examples above).
