...
with ${\ileadstoe[i]} \subseteq (\allargs × \allargs) × \Phi$, 
...
To lighten notations, $\ileadstoe[i]$ will generally be denoted by $\ileadstoe$, this symbol being understood as the result of a function of $i$. When the symbol $i$, $\ileadstoe$ or $\ileadstost$ is used in a formula without $i$ being bound, the binding $\forall i \in I$ is implied.
