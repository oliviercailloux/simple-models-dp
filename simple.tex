...
\begin{example}[no HAI]
  ...
  TODO reuse the example here above to satisfy the condition, but add some $i_1$ with empty DJ who on some path has only individuals with identical behavior on the path that have an empty DJ.
\end{example}
\begin{remark}
