...
\begin{theorem}
	Given any $p \in P, \ar_k, \ar_l \in \allargs$, consider the claim $C = \forall i \in I, \forall \set{\ar_1, \ar_2} \suchthat \set{\ar_1, \ar_2} = \set{\ar_k, \ar_l},
\forall \hist \in (…, \ar_1, ?) \nileadstog p: (\hist, …, \ar_2, ?) \ileadstog p$.
	...
	is equivalent to: 
	\begin{equation}
		\forall \set{\ar_1, \ar_2} \suchthat \set{\ar_1, \ar_2} = \set{\ar_k, \ar_l}:
