...
\begin{definition}[Reinstatement]
	A theory satisfies \emph{reinstatement} iff $\forall \ar_1, \ar_3 \in \gargs[\phi], \ar_2 \in \allargs: [\ar_1 \ileadstoe \phi, (\ar_2, \ar_1) \ileadstoe ¬\phi, (\ar_3, \ar_2) \ileadstost \phi] ⇒ (\ar_1 + \ar_3, \ar_2) \ileadstost \phi$.
\end{definition}
