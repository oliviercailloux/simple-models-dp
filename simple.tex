...
\begin{definition}
  ...
  Define the closure under observable inclusion of a claim about types $S$ as $R^\infty(S)$, equivalently, as the smallest set $S_\text{ind}$ such that $R(S_\text{ind}) \wsub S_\text{ind}$.
