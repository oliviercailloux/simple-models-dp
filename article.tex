...
\subsection{Bonus}
A model $\eta' = (\mbeats', \mleadsto', +')$ particularizes a model $\eta = (\mbeats, \mleadsto, +)$ iff $\mbeats' = \mbeats, \mleadsto' \subseteq \mleadsto, +' = +$.
\begin{theorem}[Instanciation]
	Given a decision situation and a model $\eta$ and a model particularization $\eta'$, if $\eta$ satisfies the general conditions, then $\eta'$ satisfies the general conditions.
\end{theorem}
